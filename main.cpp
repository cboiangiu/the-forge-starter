...
public:
    bool Init()
    {
        ...
        {
            PathHandle resourceDirRoot = fsAppendPathComponent(programDirectory, "../Resources");
            fsSetResourceDirectoryRootPath(resourceDirRoot);

            fsSetRelativePathForResourceDirectory(RD_TEXTURES,        "Textures");
            fsSetRelativePathForResourceDirectory(RD_MESHES,          "Meshes");
            fsSetRelativePathForResourceDirectory(RD_BUILTIN_FONTS,    "Fonts");
            fsSetRelativePathForResourceDirectory(RD_ANIMATIONS,      "Animation");
